          ...
          <h2>Bidang</h2>
		    <form action="" method="POST">
		      <select name=bidang>
		    	 ...
		    	 <option name="bidang" value="jamsostek">Bidang Pengawasan Norma Kerja & Jamsostek</option>
		    	 <option value="K3">Bidang Pengawasan Norma Kerja & Keselamatan Kerja</option>
		    	 <option value="Lindung">Bidang Pengawasan & Perlindungan Hukum Tenaga Kerja Dalam Negeri & Luar Negeri</option>
		      </select>
